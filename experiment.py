            ...
            with torch.no_grad():
                ...
                for x_T in loader:
                    if use_xstart:
                        ...
                        # print(len(x_T))
                        _xstart = x_start
                        _xstart["img"] = _xstart["img"][:len(x_T)]
                        _xstart["mask"] = _xstart["mask"][:len(x_T)]
                        _xstart["index"] = _xstart["index"][:len(x_T)]
                        _xstart["color"] = _xstart["color"][:len(x_T)]
                ...
                if save_real and use_xstart:
                    ...
                    real = self.all_gather(_xstart["img"])
